sap.ui.define([
	"sap/ui/test/Opa5",
	"com/swisscom/socialbee/plan/resourceplan/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.swisscom.socialbee.plan.resourceplan.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.swisscom.socialbee.plan.resourceplan",
					async: true
				},
				hash: oOptions.hash,
