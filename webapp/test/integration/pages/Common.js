sap.ui.define([
	...
	return Opa5.extend("com.swisscom.socialbee.plan.resourceplan.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/swisscom/socialbee/plan/resourceplan/localService/mockserver"], function (mockserver) {
