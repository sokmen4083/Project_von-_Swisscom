		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comswisscomsocialbeeplanresourceplan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comswisscomsocialbeeplanresourceplan-display": {
								"semanticObject": "comswisscomsocialbeeplanresourceplan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.swisscom.socialbee.plan.resourceplan",
									"url": sap.ui.require.toUrl("com/swisscom/socialbee/plan/resourceplan")
								}
							}
						}
					}
