sap.ui.define([
    ...
    return BaseController.extend("com.swisscom.socialbee.plan.resourceplan.controller.MitarbeiterDetail", {
        ...
        onInit : function () {
            ...
            this.getRouter().getRoute("mitarbeiterDetail").attachPatternMatched(this._onObjectMatched, this);
